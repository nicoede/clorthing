...
<nav id="p_nav" class="navbar navbar-inverse navbar-fixed-top" style="margin-bottom: -20px;">
  ...
  <section id="jackets">
    <div class="container-fluid font">
      ...
      <div class="col-md-8">
          <div class="row">
              <h2 class="text-center" style="margin-bottom: 40px; margin-top: 100px;"><b> Female Jackets </b></h2>
    <?php 
    $acessories_query = "SELECT * FROM products JOIN categories WHERE products_categories = categories_id AND categories_category LIKE '%Jackets%' AND categories_parent = 2 ";
