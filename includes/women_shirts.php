...
?>
  ...
  <section id="shirts">
    <div class="container-fluid font">
      ...
      <div class="col-md-8">
          <div class="row">
              <h2 class="text-center" style="margin-bottom: 40px; margin-top: 100px;"><b> Female Shirts </b></h2>
    <?php 
    $acessories_query = "SELECT * FROM products JOIN categories WHERE products_categories = categories_id AND categories_category LIKE '%Shirts%' AND categories_parent = 2 ";
